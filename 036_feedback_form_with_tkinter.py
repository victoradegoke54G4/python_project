...
class Feedback:
    def __init__(self, master) -> None:
        ...
        # self.logo = PhotoImage(file='C:/Users/oo/Pictures/Tekika #5759.png')
        # ttk.Label(self.header_frame, image=self.logo).grid(row=0, column=0, rowspan=2)
        ttk.Label(self.header_frame, style='Header.Tlabel', text='Thank for joining Us!').grid(row=0, column=1)
        ttk.Label(self.header_frame, wraplength=300, text='We are glad you chose Appmillers for your online study.' \
                                            ' Please tell us what you think about our onlne courses').grid(row=1, column=1)
        ...
        self.comment_text.grid(row=3, column=0, rowspan=2)
